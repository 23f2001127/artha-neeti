...
def _logo_data_uri() -> str:
    # apple-touch-icon.png (180x180) - higher-res than the 32px favicon, and
    # already generated by frontend/scripts/generate-brand-assets.mjs, so
    # there's nothing new to maintain here.
    path = _REPO_ROOT / "frontend" / "public" / "apple-touch-icon.png"
